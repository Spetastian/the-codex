const codexData = {
  codex: [
    ...
    },
    {
      ...
      title: 'Hold',
      description:
        'Hold A hero may choose to wait and see what happens by taking a Hold action. He may then go later in the round if he chooses. A Held action lasts until it’s used. If a character has a Held card when a new round starts, he’s not dealt in. If a character is Shaken while on Hold, he immediately loses'
    },
    {
      slug: 'movement',
      title: 'Movement',
      description:
        'Movement Characters may move their full Pace (usually 6” for humans) in a round. This is considered a free action and doesn’t inflict a penalty to any other actions, such as firing a weapon or taunting a foe.',
      include: [
        'crawling',
        'crouching',
        'going-prone',
      ...
      steps: [
        {
          ...
          slug: 'combat-actions',
          description:
            'Start of by resolving combat initiative for each participant.',
